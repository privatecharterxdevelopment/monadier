-- Admin dashboard: remove pending_payments (crypto subscription checkout — unused, table not on prod).
-- Fixes RPC error: relation "public.pending_payments" does not exist
