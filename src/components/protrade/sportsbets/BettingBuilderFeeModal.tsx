...
const BettingBuilderFeeModal: React.FC<Props> = ({
  buyFeeLabel,
  cashoutFeeLabel,
  maxApprovalRate,
  busy,
  ...
  <div className="hl-modal-backdrop" role="presentation" onClick={onClose}>
    <div
      className="hl-modal"
      role="dialog"
      aria-labelledby="hl-betting-fee-title"
      onClick={(e) => e.stopPropagation()}
    >
      <div className="hl-modal-head">
        <h2 id="hl-betting-fee-title" className="hl-modal-title">
          Betting platform fee
        </h2>
...
export default BettingBuilderFeeModal;
