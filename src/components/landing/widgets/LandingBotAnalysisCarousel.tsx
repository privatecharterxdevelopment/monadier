...
const trailRef = `+${HL_DYNAMIC_TRAIL.breakevenArmRoePct}→+${HL_DYNAMIC_TRAIL.armMinRoePct}%`;
...
const MOCK_SCANS: MockScan[] = [
  ...
  },
  {
    ...
    whyLine: 'ZEC: 5m SHORT 52% · 15m LONG 61% · 1h LONG 58% — timeframes disagree',
    detail: 'Bot scans all HL perps for an aligned setup elsewhere — no entry on ZEC',
    gateLine: 'Gate 8/14 — macro UP blocks SHORT while BTC pumps',
  },
  {
    coin: 'ARB',
    pos: 6,
