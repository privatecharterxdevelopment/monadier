...
export const GasEstimator: React.FC<GasEstimatorProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="p-4 dashboard-panel rounded-xl border border-border">
  ...
  return (
    <div className="p-4 dashboard-panel rounded-xl border border-border space-y-3">
      ...
      <div className="space-y-2 text-sm">
        <div className="flex justify-between">
          ...
          <span className="text-primary">${tradeAmount.toFixed(2)}</span>
        </div>

        <div className="flex justify-between">
          <span className="text-secondary">Expected Output</span>
          <span className="text-primary">{expectedOutput.toFixed(6)}</span>
        </div>

        <div className="flex justify-between">
          <span className="text-secondary">Min. Received ({slippagePercent}% slip)</span>
          <span className="text-[#52525b]">{minReceived.toFixed(6)}</span>
        </div>

        <div className="border-t border-gray-700 pt-2">
          <div className="flex justify-between">
            <span className="text-secondary">Estimated Gas</span>
            <span className={`${highGasWarning ? 'text-orange-400' : 'text-[#52525b]'}`}>
        ...
        <div className="flex justify-between">
          ...
          <span className={`${highPriceImpactWarning ? 'text-orange-400' : 'text-[#52525b]'}`}>
        ...
        <div className="border-t border-gray-700 pt-2">
          <div className="flex justify-between font-medium">
            <span className="text-primary">Net Value</span>
