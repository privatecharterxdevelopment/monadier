        ...
        <section className="container-custom mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl border border-black/[0.06] bg-black/[0.03]"
            >
              <div className="w-12 h-12 rounded-xl bg-black/[0.04] flex items-center justify-center mb-6">
                <Mail className="text-primary/60" size={24} />
              </div>
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-black/[0.04] flex items-center justify-center mb-6">
                <Clock className="text-primary/60" size={24} />
              </div>
              <h3 className="text-xl font-display font-medium text-primary mb-2">
                Support Hours
              </h3>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-primary font-medium">09:00 - 20:00 CET</span>
                </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                className="p-6 rounded-2xl border border-black/[0.06] bg-black/[0.03]"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-primary font-medium mb-2">{faq.question}</h3>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link to="/support" className="text-secondary hover:text-primary text-sm transition-colors">Support</Link>
