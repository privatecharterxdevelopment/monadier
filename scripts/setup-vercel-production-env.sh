...
add_env VITE_PLATFORM_FEE_TREASURY_ADDRESS "${VITE_PLATFORM_FEE_TREASURY_ADDRESS:-0x1fbc2a0ab6a8fa5f6b9645392433483b25a8cd84}"
add_env VITE_HL_PRO_TRADE_SUCCESS_FEE_BPS "${VITE_HL_PRO_TRADE_SUCCESS_FEE_BPS:-150}"
