...
/**
 * @title MonadierTradingVaultV2
 * @notice Trading vault with position holding - supports buy, hold, and sell
 * @dev Allows bot to open positions and close them later (for trailing stops)
 */
contract MonadierTradingVaultV2 is ReentrancyGuard, Pausable {
        ...
        returns (uint256 usdcOut)
    {
        ...
        emit PositionClosed(user, token, tokenAmount, netUsdcOut, fee);
        return netUsdcOut;
    }
