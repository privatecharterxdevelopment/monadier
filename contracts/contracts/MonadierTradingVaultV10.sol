...
/**
 * @title MonadierTradingVaultV10
 * @author Monadier Team
 * @notice GMX Perpetuals Trading Vault - V10 SECURE BOT Edition
 *
 * @dev V10 = V9 with NEW SECURE BOT WALLET
 *   - All V9 BULLETPROOF features
...
contract MonadierTradingVaultV10 is ReentrancyGuard, Pausable, Ownable {
