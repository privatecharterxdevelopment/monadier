...
export const config = {
  ...
  hyperliquid: {
    ...
    /** Min ms before opposite direction on same coin after close (default 10 min — not a global 30m ban). */
    blockOppositeSameCoinMs: Number(process.env.HL_BLOCK_OPPOSITE_SAME_COIN_MS || 600_000),
