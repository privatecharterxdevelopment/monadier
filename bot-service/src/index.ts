  ...
  if (url.pathname === '/health' || url.pathname === '/') {
    ...
    const status = {
      ...
      policy: {
        ...
        trailMs: {
          armMinProfitHoldMs: config.hyperliquid.dynamicTrail.armMinProfitHoldMs,
          maxHoldBeforeSlTrailMs: config.hyperliquid.dynamicTrail.maxHoldBeforeSlTrailMs,
          trailMinActiveBeforeCloseMs: config.hyperliquid.dynamicTrail.trailMinActiveBeforeCloseMs,
    ...
    try {
      ...
      res.end(JSON.stringify({
        ...
        globalScan: {
          ...
          scanUniverseCoins: lastHlGlobalScanStats.coins,
          botUniverse: lastHlGlobalScanStats.coins,
